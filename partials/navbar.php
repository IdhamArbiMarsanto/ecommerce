        ...
        <div class="row border-top px-xl-5">
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                    <a href="" class="text-decoration-none d-flex align-items-center d-block d-lg-none">
                        <img src="img/logo.jpg" alt="Logo" style="height: 40px; width: auto;" class="mr-1 border" />
